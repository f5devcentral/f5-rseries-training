...
`Differences from iSeries and VIPRION <https://clouddocs.f5networks.net/training/community/rseries-training/html/rseries_points_of_management.html#differences-from-iseries-and-viprion>`_
