...
To align with CC certification requirements and to ensure functional parity across secure operating modes, the existing integrity-check mechanisms are now extended to operate in Common-Criteria mode as well. Below is an example of a boot time integrity failure detected.
